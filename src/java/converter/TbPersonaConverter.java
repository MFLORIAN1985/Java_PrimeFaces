...
@FacesConverter(value = "tbPersonaConverter")
public class TbPersonaConverter implements Converter {

    private TbPersonaFacade ejbFacade;
    ...
    private TbPersonaFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TbPersonaFacade.class).get();
